...
Route.group(() => {
  ...
  Route.post('/workshops/:workshop_id/subscriptions', 'SubscriptionController.store')
  Route.delete('/workshops/:workshop_id/subscriptions', 'SubscriptionController.destroy')
